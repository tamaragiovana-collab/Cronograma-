...
# Find and replace the RAW_MODULES section
start = content.find("const RAW_MODULES = [")
end = content.find("];\n\n// Compute prevalence score")
if start != -1 and end != -1:
    content = content[:start] + NEW_RAW_MODULES + "\n" + content[end+2:]
    print("RAW_MODULES replaced, new length:", len(content))
else:
    print("NOT FOUND", start, end)

with open('residencia-medica.jsx', 'w') as f:
    f.write(content)
EOF
